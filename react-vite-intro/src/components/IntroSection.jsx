...
//       <h3 className="centered" style={{ color: '#655'}}>
...
export default function IntroSection() {
  return React.createElement('section', null, [
    ...
    React.createElement('h3', { className:'centered', key: 2, style: {color: '#655'} }, 'Университет frontend-разработки, который насыщает IT-сферу квалифицированными программистами'),
  ])
} 